...
import { StyleSheet, Text, View, Image, TouchableOpacity, FlatList, ColorPropType } from 'react-native'
...
img: images.skiVilla
    ...
    function renderDistination(item, index) {
...
/>
            ...
            {/* Destination */}
            <View style={{flex:1}}>
<Text style={{marginTop:SIZES.base*1.5,marginHorizontal:SIZES.padding, ...FONTS.h2 }}>Destination</Text>
<FlatList
horizontal
showsHorizontalScrollIndicator={false}
data={destinations}
keyExtractor={item => item.id.toString()}
renderItem={({item, index}) => renderDistination(item, index)}
